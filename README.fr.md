...
<p>
  ...
  <img alt="Flask" src="https://img.shields.io/badge/Flask-web%20UI-000000?style=flat-square&logo=flask&logoColor=white">
  <img alt="Docker" src="https://img.shields.io/badge/Docker-sandbox-2496ED?style=flat-square&logo=docker&logoColor=white">
  <img alt="C++" src="https://img.shields.io/badge/C%2B%2B-runner-00599C?style=flat-square&logo=cplusplus&logoColor=white">
  <img alt="Java" src="https://img.shields.io/badge/Java-runner-ED8B00?style=flat-square&logo=openjdk&logoColor=white">
  <img alt="Linux" src="https://img.shields.io/badge/Linux-teacher%20server-FCC624?style=flat-square&logo=linux&logoColor=black">
  <img alt="Cloudflare" src="https://img.shields.io/badge/Cloudflare-tunnel-F38020?style=flat-square&logo=cloudflare&logoColor=white">
  <img alt="ntfy" src="https://img.shields.io/badge/ntfy-phone%20notifications-00ACD7?style=flat-square">
</p>
...
![Page d'accueil MAAT](docs/screenshots/home.png)

![Page de dépôt](docs/screenshots/upload.png)

![Classements](docs/screenshots/ranking.png)

![Page d'administration](docs/screenshots/admin.png)
...
- **Langage autorisé** : C++.
- **Entrée** : fichier texte contenant `n`, puis une matrice `n x n` de distances. Les 12 instances TSP fournies vont de 10 à 20 villes et leur nom expose la catégorie, la graine et le nombre de villes.
- **Algorithme exemple** : construction randomisée par plus proche voisin suivie d'une recherche locale 2-opt bornée, avec conservation du meilleur tour trouvé.
- **Paramètres principaux** : instance TSP, catégorie (`easy`, `medium`, `hard`), graine PRNG, nombre de villes entre 10 et 20, matrice des distances, nombre d'itérations heuristiques, taille du pool candidat.
...
`./manage-maat.sh uninstall` stoppe/supprime les conteneurs MAAT et enlève les répertoires régénérables `logs`, `runs` et `submissions`.

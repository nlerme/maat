...
![MAAT home page](docs/screenshots/home.png)

![Upload page](docs/screenshots/upload.png)

![Leaderboards](docs/screenshots/ranking.png)

![Administration page](docs/screenshots/admin.png)
...
- **Allowed language**: C++.
- **Input**: a text file containing `n`, followed by an `n x n` distance matrix. The 12 bundled TSP instances range from 10 to 20 cities and their filenames expose category, seed and city count.
- **Sample algorithm**: randomized nearest-neighbor construction followed by bounded 2-opt local search, keeping the best tour seen so far.
- **Main parameters**: TSP instance, category (`easy`, `medium`, `hard`), PRNG seed, number of cities from 10 to 20, distance matrix, heuristic iterations, candidate pool size.
